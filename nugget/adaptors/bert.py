...
class NuggetBertSelfAttention(BertSelfAttention):
    # modified from Transformers 4.35.0
...
def adapt_bert(feeder, base_model, scorer_layer, residual_start, residual_end):
    for i_layer in range(residual_start, residual_end):
        ...
        attn_module.nugget_attn = feeder
    # for scorer feature feeder
    model = deepcopy(base_model)
    model.encoder.layer = model.encoder.layer[:scorer_layer]
    model.pooler = None
    return feeder, model
